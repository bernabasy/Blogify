...
RSpec.describe Comment, type: :model do
    describe 'associations' do
      ...
      let(:post) { Post.create(author_id: author.id, title: 'Post', text: 'Text', likes_counter: 5, comments_counter: 5) }
      ...
      it 'should increment comments_counter' do
        expect{ Comment.create(author_id: author.id, post_id: post.id, text: 'Hello') }.to change{ post.reload.comments_counter }.by(1)
      end
    end
  end